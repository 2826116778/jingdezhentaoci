...
// 使用 Unsplash 风格外链图片（真实可访问，陶瓷 / 酒店 相关），支持高清展示
// 统一使用 picsum.photos 稳定占位服务 + seed 固定 → 图片稳定不变
const PIC = (seed: string, w = 1200, h = 800) => `https://picsum.photos/seed/${encodeURIComponent(seed)}/${w}/${h}`;
...
const products = [
  // 1~2 餐桌瓷
  {
    ...
    images: [PIC('ceramic-gold-plate-set-01', 1400, 900), PIC('ceramic-gold-plate-set-02'), PIC('ceramic-gold-plate-set-03')],
    detailImages: [PIC('ceramic-gold-closeup-rim', 1200, 800), PIC('ceramic-gold-stamp', 1200, 800)],
  ...
  },
  {
    ...
    size: 'Ø22cm × H7.5cm',
    images: [PIC('ceramic-bluewhite-bowl-01', 1400, 900), PIC('ceramic-bluewhite-bowl-02'), PIC('ceramic-bluewhite-bowl-03')],
    detailImages: [PIC('ceramic-bluewhite-brush-closeup', 1200, 800)],
  ...
  // 3~4 花瓶
  {
    ...
    size: 'Ø40cm × H55cm',
    images: [PIC('ceramic-matte-gold-vase-01', 1400, 900), PIC('ceramic-matte-gold-vase-02'), PIC('ceramic-matte-gold-vase-03')],
    detailImages: [PIC('ceramic-matte-gold-texture', 1200, 800), PIC('ceramic-vase-glaze-close', 1200, 800)],
  ...
  },
  {
    ...
    size: 'Ø46cm × H120cm',
    images: [PIC('ceramic-drip-glaze-01', 1400, 900), PIC('ceramic-drip-glaze-02'), PIC('ceramic-drip-glaze-03')],
    detailImages: [PIC('ceramic-drip-glaze-closeup', 1200, 800)],
  ...
  // 5~6 艺术雕塑
  {
    ...
    size: 'L50 × W28 × H62cm',
    images: [PIC('ceramic-swan-sculpture-01', 1400, 900), PIC('ceramic-swan-sculpture-02')],
    detailImages: [PIC('ceramic-swan-feather-detail', 1200, 800)],
  ...
  },
  {
    ...
    size: 'Ø50cm × H24cm',
    images: [PIC('ceramic-celadon-lotus-01', 1400, 900), PIC('ceramic-celadon-lotus-02')],
    detailImages: [PIC('ceramic-celadon-petals-close', 1200, 800)],
  ...
  // 7~8 酒店瓷
  {
    ...
    images: [PIC('ceramic-hotel-presidential-01', 1400, 900), PIC('ceramic-hotel-presidential-02'), PIC('ceramic-hotel-presidential-03')],
    detailImages: [PIC('ceramic-hotel-logo-detail', 1200, 800)],
  ...
  },
  {
    ...
    images: [PIC('ceramic-hotel-buffet-01', 1400, 900), PIC('ceramic-hotel-buffet-02'), PIC('ceramic-hotel-buffet-03')],
    detailImages: [],
  ...
  // 9~10 瓷砖
  {
    ...
    size: '300 × 600 × 10mm',
    images: [PIC('ceramic-tile-cream-wall-01', 1400, 900), PIC('ceramic-tile-cream-wall-02')],
    detailImages: [PIC('ceramic-tile-edge-detail', 1200, 800)],
  ...
  },
  {
    ...
    size: '600 × 600 × 10.5mm',
    images: [PIC('ceramic-tile-gold-inlay-01', 1400, 900), PIC('ceramic-tile-gold-inlay-02')],
    detailImages: [PIC('ceramic-tile-gold-line-close', 1200, 800)],
  ...
  // 11~12 OEM 样品
  {
    ...
    images: [PIC('ceramic-sapphire-teapot-01', 1400, 900), PIC('ceramic-sapphire-teapot-02'), PIC('ceramic-sapphire-teapot-03')],
    detailImages: [PIC('ceramic-gold-teapot-lid-detail', 1200, 800)],
  ...
  },
  {
    ...
    category: 'oem-sample' as const, material: 'porcelain' as const, glazeColor: 'Multi-color hand-painted',
    size: 'Ø45cm',
    images: [PIC('ceramic-middleeast-platter-01', 1400, 900), PIC('ceramic-middleeast-platter-02'), PIC('ceramic-middleeast-platter-03')],
    detailImages: [PIC('ceramic-handpaint-detail', 1200, 800)],
    isCustom: true, isStock: false, moq: 50, priceMin: 120, priceMax: 220,
    oemOptions: ['logo', 'glaze', 'shape', 'size', 'packaging'] as const,
    careEn: 'Indoor decorative piece — dust only.',
    careAr: 'قطعة ديكور داخلية — غبار فقط.',
    shippingNoteEn: 'Hanging hook + foam insert box.',
    shippingNoteAr: 'حامل تعليق + صندوق مبطن بالرغوة.',
...
const cases = [
  {
    ...
    coverImage: PIC('case-burjalarab-cover', 1600, 1000),
    images: [PIC('case-burjalarab-1'), PIC('case-burjalarab-2'), PIC('case-burjalarab-3')],
  ...
  },
  {
    ...
    coverImage: PIC('case-atlantis-cover', 1600, 1000),
    images: [PIC('case-atlantis-1'), PIC('case-atlantis-2')],
  ...
  },
  {
    ...
    coverImage: PIC('case-villa-palm-cover', 1600, 1000),
    images: [PIC('case-villa-palm-1'), PIC('case-villa-palm-2'), PIC('case-villa-palm-3')],
  ...
  },
  {
    ...
    coverImage: PIC('case-apartment-dt-cover', 1600, 1000),
    images: [PIC('case-apartment-dt-1'), PIC('case-apartment-dt-2')],
  ...
  },
  {
    ...
    coverImage: PIC('case-dubaimall-lobby-cover', 1600, 1000),
    images: [PIC('case-dubaimall-lobby-1'), PIC('case-dubaimall-lobby-2')],
  ...
  },
  {
    ...
    coverImage: PIC('case-difc-club-cover', 1600, 1000),
    images: [PIC('case-difc-club-1'), PIC('case-difc-club-2')],
  ...
  },
  {
    ...
    coverImage: PIC('case-riyadh-ritz-cover', 1600, 1000),
    images: [PIC('case-riyadh-ritz-1'), PIC('case-riyadh-ritz-2')],
  ...
  },
  {
    ...
    year: 2023, category: 'hotel' as const,
    coverImage: PIC('case-abd-palace-cover', 1600, 1000),
    images: [PIC('case-abd-palace-1'), PIC('case-abd-palace-2'), PIC('case-abd-palace-3')],
